...
**On confirmation prompts.** Emacs asks before applying a directory-local variable unless the package has vouched for the value, and this package vouches for everything marked **✓** in the parameter table, so a project's `.dir-locals.el` normally just works.
